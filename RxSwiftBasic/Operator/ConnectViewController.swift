...
class ConnectViewController: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationItem.title = "Public、Connect、Replay、Multicast、ReCount"
...
//        Replay()
        ...
        self.codeText.text = """
                             ...
                             */
                             ...
                             /**
                             * @Date: 2019/12/27 9:28 上午
                             * @Description: ReCount操作符可以将可连接的Observable转换为普通Observable
                             *               即该操作符可以自动连接和断开可连接的 Observable。当第一个观察者对可连接的 Observable 订阅时，
                             *               那么底层的 Observable 将被自动连接。当最后一个观察者离开时，那么底层的 Observable 将被自动断开连接。
                             * @Param: -
                             * @Author: jie
                             * @return: -
                             */
